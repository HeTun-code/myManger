	...
	<script type="text/javascript">
	    $(function(){
	 		   ...
	 		   if(checkedBoxs.length < 1){
	 			   ...
	 			   $.ligerDialog.confirm("确认要删除吗?","删除文档",function(r){
	 				   if(r){
	 					   // alert("删除："+ids.get());
	 					   // 发送请求
	 					   window.location = "${pageContext.request.contextPath }/downs.action?method=deleteDownload&ids=" + ids.get();
	 				   }
	 			   });
	 		   }
	 	   })
	    	...
	    	$("a[id^='down_']").click(function(){
	    		...
	    		/** 下载该文档 */
	    		window.location = "${pageContext.request.contextPath }/downs.action?method=download&id="+id;
	    	})
	...
	<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
	  ...
	  <tr valign="top">
	    <td height="30">
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr>
			  <td class="fftd">
			  	<form name="documentform" method="post" id="documentform" action="${pageContext.request.contextPath }/downs.action">
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
					    	标题：<input type="text" name="documentTitle" />
				...
				<tr ondblclick="down(${document.documentId});"  class="main_trbg" align="center" id="data_${stat.index}">
					<td><input type="checkbox" id="box_${stat.index}" value="${document.documentId}"></td>
					 ...
					 <td>${document.createTime}</td>
					  ...
					  <td>${document.documentDes }</td>
					 <td align="center" width="40px;"><a href="${pageContext.request.contextPath }/downs.action?method=findById&documentId=${document.documentId}">
	  ...
	  <tr valign="top"><td align="center" class="font3">
	  	   <fkjava:pager 
	  	      ...
	  	      submitUrl="${pageContext.request.contextPath}/document/selectDocument.action?pageModel.pageIndex={0}&document.documentTitle=${document.documentTitle}"
	  	      style="flickr"
	  	      />
	  </td></tr>
	</table>
