...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
	<tr valign="top">
		<td>
			<form action="/addUser.action" id="userForm" method="post">
				<!-- 隐藏表单，flag表示添加标记 -->
					...
					<tr><td class="font3 fftd">
						<table>
							<tr>
								...
								<td class="font3 fftd">电话：<input type="text" name="telNum" id="status" size="20"/></td>
							</tr>

							<tr>
								<td class="font3 fftd">登录名：<input name="userLoginName" id="userName" size="20" /></td>
								<td class="font3 fftd">密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码：<input name="password" id="password" size="20" /></td>
							</tr>

							<tr>
								<td class="font3 fftd">简介：<input name="userIntroduce" id="userName" size="20" /></td>
								<td class="font3 fftd">部&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;门：
									<select id="mission_id" name="mission.missionId" style="width:143px;">
