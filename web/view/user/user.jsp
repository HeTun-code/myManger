                ...
                if (checkedBoxs.length < 1) {
                    ...
                    $.ligerDialog.confirm("确认要删除吗?", "删除用户", function (r) {
                        if (r) {
                            // alert("删除："+ids.get());
                            // 发送请求
                            window.location.href = "/delUser.action?userId=" + ids.get();
                        }
                    });
                }
            })
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="font3">
                                        ...
                                        电话：<input type="text" name="telNum">
            ...
            <table width="100%" border="1" cellpadding="5" cellspacing="0"
                ...
                <c:forEach items="${users}" var="user" varStatus="stat">
                    <tr id="data_${stat.index}" align="center" class="main_trbg" onMouseOver="move(this);"
                        ...
                        <td>${user.mission.missionName }</td>
                        <td align="center" width="40px;"><a
                                href="/changeUser.action?userId=${user.userId}">
