    ...
    <td>
    	 <form action="${pageContext.request.contextPath}/emps.action" id="employeeForm" method="post">
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			...
		    			<td class="font3 fftd">身份证号码：<input type="text" name="idCard" id="cardId" size="20"/></td>
		    		</tr>
		    		<tr>
			...
			<tr>
				<td class="font3 fftd">
					政治面貌：<input name="politicalStatus" id="party" size="40"/>&nbsp;&nbsp;
				</td>
			</tr>
			<tr><td class="main_tdbor"></td></tr>
			...
			<tr>
				<td class="font3 fftd">
					...
					民&nbsp;&nbsp;&nbsp;&nbsp;族：<input name="empVolk" id="race" size="20"/>
				</td>
			</tr>
			<tr><td class="main_tdbor"></td></tr>
			...
			<tr>
				<td class="font3 fftd">
					...
					爱&nbsp;&nbsp;&nbsp;&nbsp;好：<input name="empHabbit" id="hobby" size="20"/>
				</td>
			</tr>
			<tr><td class="main_tdbor"></td></tr>
