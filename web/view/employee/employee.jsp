	    		   ...
	    		   if(checkedBoxs.length < 1){
	    			   ...
	    			   $.ligerDialog.confirm("确认要删除吗?","删除员工",function(r){
	    				   if(r){
	    					   // alert("删除："+ids.get());
	    					   // 发送请求
	    					   window.location = "${pageContext.request.contextPath}/emps.action?method=deleteEmp&ids=" + ids.get();
	    				   }
	    			   });
	    		   }
	    	   })
	  ...
	  <tr valign="top">
	    <td height="30">
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr>
			  <td class="fftd">
			  	<form name="empform" method="post" id="empform" action="${pageContext.request.contextPath}/emps.action?method=turnM">
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
					    	职位：
					    	...
					    	身份证号码：<input type="text" name="idCard" maxlength="18">
					    </td>
					  </tr>
					  <tr>
					    <td class="font3">
					    	...
					    	手机：<input type="text" name="telNum">
				...
				<tr id="data_${stat.index}" class="main_trbg" align="center">
					<td><input type="checkbox" id="box_${stat.index}" value="${employee.empId}"></td>
					 <td>${employee.empName }</td>
					  ...
					  <td>${employee.empVolk}</td>
					  <td>${employee.empHabbit}</td>
					  <td>${employee.remark}</td>
					  <td>${employee.politicalStatus}</td>
					  <td>${employee.major}</td>
					  <td align="center" width="40px;"><a href="${pageContext.request.contextPath}/emps.action?method=findEmpById&empId=${employee.empId}">
