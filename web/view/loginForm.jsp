...
<body style="font-family: 微软雅黑">
	<div class="page-lock">
		...
		<form action="${pageContext.request.contextPath}/users.action" method="post"
			id="loginForm">
			...
			<div class="page-body">
				...
				<div class="page-lock-info">
						...
						<div class="controls">
							<div class="input-icon left">
								...
								<input
									...
									id="loginname" name="userLoginName" value="qwe123" >
							</div>
						</div>
					</div>
					<div class="control-group">
					...
					<div class="control-group">
						<div class="controls">
							<div class="input-icon left">
								<i class="icon-lock"></i>记住我： <input
									class="m-wrap placeholder-no-fix" type="checkbox"
									 id="rememeberMe" name="remeberMe">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="page-footer" style="color: #fff">
				兼容浏览器IE8+，最佳分辨率1280*800. <br>2015 @ 咸鱼片 http://www.fkit.org
			</div>
		</form>
	</div>
